...
public class isPalindrome_9 {
    ...
    public static void main(String[] args) {
        boolean ans1=new isPalindrome_9().isPalindrome(-11);
        boolean ans2=new isPalindrome_9().isPalindrome(11);
        boolean ans3=new isPalindrome_9().isPalindrome(121);
        boolean ans4=new isPalindrome_9().isPalindrome(0);
